classdef AStarSearch < handle
    ...
    methods
        ...
        function path = PathPlanning(obj)
            ...
            empty_node.count = Inf;
            empty_node.parent = Inf;
            empty_node.row = Inf;
            empty_node.col = Inf;
            
            start_node = empty_node;
            start_node.f_cost = 0;
            start_node.count = start_count;
            start_node.parent = start_count;
            ...
            while open_list_remain > 0 && ~reach_goal
                ...
                current_node_pq = open_list_pq.PopNode();
                current_node_idx = current_node_pq.count;
